...
export const pitchChapters: PitchChapterContent[] = [
  ...
  },
  {
    ...
    index: 5,
    title: "Detect → Understand → Inspect → Verify.",
    body: "InjectWatch assembles evidence and uncertainty, prioritises candidate events, supports expert-approved inspection, captures field observations and verifies the outcome.",
    speaker: "Lily",
    timeRange: "1:38–2:02",
    ...
    supplementPoints: [
      "Inspection approval converts a candidate into a bounded information-gathering task.",
      "Technical review separates observed evidence from an authorised scenario action.",
  ...
  },
  {
    ...
    body: "The plan remains stable while actual injection declines. Wellhead pressure rises, upstream manifold pressure stays stable, and the system prioritises one candidate without claiming a confirmed root cause.",
    speaker: "Lily",
    timeRange: "2:02–3:40",
    ...
    supplementPoints: [
      ...
      "Stable manifold pressure weakens a broad upstream explanation but does not prove a local cause.",
